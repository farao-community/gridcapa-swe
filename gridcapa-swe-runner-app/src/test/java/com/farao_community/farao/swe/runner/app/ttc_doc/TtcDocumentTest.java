...
class TtcDocumentTest {
    ...
    @Test
    void simpleTest() {
        SweDichotomyResult dichotomyResult = new SweDichotomyResult(DichotomyDirection.ES_FR, mock(DichotomyResult.class), Optional.empty(), "exportedLastSecureCgmesUrl", "exportedFirstUnsecureCgmesUrl", "", "");
