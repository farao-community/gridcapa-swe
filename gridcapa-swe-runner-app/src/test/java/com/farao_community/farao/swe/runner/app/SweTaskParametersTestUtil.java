...
public final class SweTaskParametersTestUtil {
    ...
    public static SweTaskParameters getSweTaskParameters() {
        ...
        parameters.add(new TaskParameterDto("STARTING_POINT_ES-FR", "INT", "82", "1515"));
        parameters.add(new TaskParameterDto("STARTING_POINT_FR-ES", "INT", "83", "1515"));
        parameters.add(new TaskParameterDto("STARTING_POINT_ES-PT", "INT", "84", "1515"));
        parameters.add(new TaskParameterDto("STARTING_POINT_PT-ES", "INT", "85", "1515"));
        parameters.add(new TaskParameterDto("MIN_POINT_ES-FR", "INT", "42", "1515"));
        parameters.add(new TaskParameterDto("MIN_POINT_FR-ES", "INT", "43", "1515"));
        parameters.add(new TaskParameterDto("MIN_POINT_ES-PT", "INT", "44", "1515"));
        parameters.add(new TaskParameterDto("MIN_POINT_PT-ES", "INT", "45", "1515"));
